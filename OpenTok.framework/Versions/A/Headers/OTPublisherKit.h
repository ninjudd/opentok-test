...
/**
 * Sent when an archive starts or stops recording the publsher's stream.
 *
 * You may want to add or remove a user interface element indicating that
 * recording has started or stopped, based on this message.
 *
 * @param publisher The publisher that has started or stopped being recorded.
 * @param isArchiving Whether the recording has started (`YES`) or stopped
 * (`NO`).
 */
